...
export class DashboardComponent  {
  ...
  data:string = '';
    ...
    constructor(private userService:UsersService,private router:Router,private hotelService:HotelsService){}
    ...
    updatePhoneNumber(idForm: any): void {
      ...
      if (id && phoneNumber) {
        ...
        console.log(`Navigating to update phone number for User ID: ${id}, Phone Number: ${phoneNumber}`);
      } else {
